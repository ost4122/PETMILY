			...
			<table>
				...
				<tr>
					...
					<td><input type="hidden" id="Itemprice"
						value=${item.item_price}>${item.item_price}원</td>
				</tr>
				<tr>
					<td><strong>배송비</strong></td>
					<td><input type="hidden" id="delivery" value=20000>20000원</td>
				</tr>
				<tr>
					<td><strong>총결제금액</strong></td>
					<td><strong style="color: blue;">${totalPrice}</strong>원</td>
				</tr>

				<tr>
					<td><strong>결제방법</strong></td>
					<td><input type="radio" id="paymentOption"
						name="paymentOption" value="신용/체크카드" required>신용/체크카드 <input
						type="radio" name="paymentOption" value="KakaoPay" required>카카오페이</td>
				</tr>
			</table>
