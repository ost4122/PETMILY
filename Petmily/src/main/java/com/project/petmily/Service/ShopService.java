...
public class ShopService {
	...
	public ModelAndView Shop_List() {
		...
		/*
		 * PageDTO pageDTO = new PageDTO(); int limit = 3; pageDTO.setPage(page);
		 * pageDTO.setLimit(limit);
		 * 
		 * int startRow = (page-1)*limit+1; int endRow = page*limit;
		 * 
		 * pageDTO.setStartRow(startRow); pageDTO.setEndRow(endRow);
		 */
		...
		/*
		 * int endPage = startPage + 10- 1; if(endPage>maxPage) { endPage = maxPage; }
		 * 
		 * 
	...
	public ModelAndView Shop_View(int item_number) {
		...
		mav.addObject("Review_Img", reviewImg);
